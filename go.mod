module github.com/volts-dev/cacher
...
require (
	...
	github.com/volts-dev/volts v0.0.0-20251015041220-7c1a12b04090 // indirect
...
require (
	...
	github.com/volts-dev/dataset v0.0.0-20251213114329-6b93f1126177
)
